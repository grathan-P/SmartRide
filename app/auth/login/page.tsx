...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Mock authentication
    setTimeout(() => {
      localStorage.setItem("smartride_user", JSON.stringify({ email, name: "User" }))
      router.push("/")
    }, 1500)
  }
      ...
      >
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm overflow-hidden">
          ...
          <CardHeader className="relative text-center pb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to your SmartRide account</p>
          </CardHeader>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-slate-700/50 border-slate-600 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500/20"
                    required
                  />
                  <button
                    type="button"
